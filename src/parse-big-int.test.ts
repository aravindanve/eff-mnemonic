...
describe("parseBigInt", () => {
  ...
  it("should throw TypeError if radix is not between 2 and 36", () => {
  ...
  it("should throw a TypeError for invalid characters based on radix", () => {
